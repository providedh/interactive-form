...
export default function Component({sourceName, source, annotations, draggedCategory, boundAddProvidedhCategory, useCase, boundRemoveProvidedhCategory}) {
	const ref = useRef()
	...
	function onDrop(words){
		boundAddProvidedhCategory({useCase, words, category: draggedCategory})
	}
	...
	function getFragments(){
		...
		sorted.forEach((annotation, i) => {
			...
			const mapped = annotation.providedhCategories.join(', ')
